...
def water_occurrence_tif(cfg):
    ...
    srs = "+proj=longlat +datum=WGS84 +ellps=WGS84"
    option = gdal.WarpOptions(multithread=True, options=gs.CONFIG, dstSRS=srs,
                              creationOptions=gs.CREATION, outputBounds=bound,
                              xRes=t[1], yRes=t[5], resampleAlg=gdal.GRA_Average,
                              outputType=gdal.GDT_Float64, dstNodata=cfg.gdal.nodata)
