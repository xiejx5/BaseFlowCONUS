...
class EALSTM(nn.Module):
    def __init__(self, input_size_sta, input_size_dyn, hidden_size, output_size, num_layers, drop_prob=0.5):
        ...
        self.lstm = SingleEALSTM(input_size_sta, input_size_dyn, hidden_size,
...
class SingleEALSTM(nn.Module):
    ...
    def __init__(self,
        ...
        self.weight_sh = nn.Parameter(torch.FloatTensor(input_size_sta, hidden_size))
    ...
    def forward(self, x_s: torch.Tensor, x_d: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        """[summary]
        Parameters
        ----------
        x_d : torch.Tensor
